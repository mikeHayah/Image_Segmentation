...
class PatchImageFolder(ImageFolder):
	...
	def _extract_patches(self, image, GT):
		...
		GT_tensor = T.ToTensor()(GT).unsqueeze(0)  # Convert to tensor and add batch dimension
	...
	def __getitem__(self, index):
		...
		# create patches   
		img_patches, GT_patches  = self._extract_patches(image, GT)
	...
	def transformation(self, mode='train',augmentation_prob=0.4):
